...
public class AlarmReceiver4 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        builder.setAutoCancel(true).setDefaults(NotificationCompat.DEFAULT_ALL)
                .setContentTitle("30분 후 알람을 알려드립니다.")
                .setContentText("30분마다 알람이 울립니다.")
        ...
        Intent i = new Intent(context, AlarmReceiver4.class);
        PendingIntent pendingIntent = PendingIntent.getBroadcast(context, 40, i, PendingIntent.FLAG_UPDATE_CURRENT);

        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            alarmManager.setExactAndAllowWhileIdle(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + (60 * 1000 * 30), pendingIntent);
        } else {
            alarmManager.setExact(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + (60 * 1000 * 30), pendingIntent);
        }
    }
}
